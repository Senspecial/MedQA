...
try:
    from transformers.utils import LossKwargs  # 对应 >=4.59 之类的新版本
except ImportError:
    # 旧版本没有 LossKwargs，这里定义一个空的占位类型就行，它只用来做类型标注
    from typing import TypedDict

    class LossKwargs(TypedDict, total=False):
        """Fallback for old transformers versions without LossKwargs."""
        pass
